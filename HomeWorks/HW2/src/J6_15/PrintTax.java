...
public class PrintTax {
    ...
    public void printTax(){
        System.out.printf("%20s %20s %20s %20s", "Income","Single", "Married Joint", "Married Separate", "Head of a House");
        System.out.println();
        for( int income = 50000; income<60050; income+=50){
    ...
    public static double computeTax(int status, double income){
        ...
        if (status == 0) { // Compute tax for single filers
            ...
            if (income <= 16700)
                ...
                tax = 16700 * 0.10 + (137050 - 16700) * 0.15 + (208850 - 137050) * 0.25 +
                        (372950 - 208850) * 0.28 +
                        (income - 372950) * 0.33;
            else
                tax = 16700 * 0.10 + (137050 - 16700) * 0.15 +
                        (208850 - 137050) * 0.25 + (372950 - 208850) * 0.28 +
